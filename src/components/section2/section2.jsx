...
const Section2 = ({ isMobile, isSection2, scrollProgress }) => {
    ...
    return (
        <div className="section2-main">
            <div className={isMobile ? "section2-mobile-phone" : "section2-desktop-phone"}>
            ...
            <div className={isMobile ? "section2-mobile-UI" : "section2-desktop-UI"}>
                <div className={isMobile ? "dots-container" : "dots-container-desktop"}>
                    {[0, 1, 2, 3].map((index) => (
                        <div
                            key={index}
            ...
            <div className={isMobile ? "section2-mobile-text" : "section2-desktop-text"}>
                <div className={isMobile ? "section2-mobile-text-wrapper" : ""}>
                    <h1>{title}</h1>
                    <p>{description}</p>
                </div>
            </div>
